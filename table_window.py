...
class AppTable(QWidget):
    def __init__(self):
        ...
        button_import_excel = QPushButton('Refresh data')
        # button_import_excel.clicked.connect(lambda: BookSearch().refresh_click())
        # button_import_excel.clicked.connect(lambda: table.model.dataChanged.connect(table.view.update()))
        buttonLayout.addWidget(button_import_excel)
